...
const centerSchema = new mongoose.Schema({
  ...
  shifts: {
    morning:  { type: shiftSchema, required: true, default: () => ({ startMinute: 8*60,  endMinute: 12*60 }) },
    afternoon:{ type: shiftSchema, required: true, default: () => ({ startMinute: 13*60, endMinute: 17*60 }) },
    evening:  { type: shiftSchema, required: true, default: () => ({ startMinute: 18*60, endMinute: 22*60 }) }
  },
});
